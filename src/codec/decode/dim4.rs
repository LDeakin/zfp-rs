...
// Strided
pub fn decode_block_strided_4d_f64(
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_f64(bs, MINBITS, DOUBLE_MAXBITS, DOUBLE_MAXPREC, DOUBLE_MINEXP);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}
pub fn decode_block_strided_4d_f32(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [f32],
    sx: isize,
    sy: isize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_f32(bs, MINBITS, FLOAT_MAXBITS, FLOAT_MAXPREC, FLOAT_MINEXP);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}
pub fn decode_block_strided_4d_i32(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i32],
    sx: isize,
    sy: isize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_i32(bs, MINBITS, INT32_MAXBITS, INT32_MAXPREC);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}
pub fn decode_block_strided_4d_i64(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i64],
    sx: isize,
    sy: isize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_i64(bs, MINBITS, INT64_MAXBITS, INT64_MAXPREC);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}

// Partial strided
pub fn decode_partial_block_strided_4d_f64(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [f64],
    nx: usize,
    ny: usize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_f64(bs, MINBITS, DOUBLE_MAXBITS, DOUBLE_MAXPREC, DOUBLE_MINEXP);
    scatter_partial_4d(&block, data, nx, ny, nz, nw, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}
pub fn decode_partial_block_strided_4d_f32(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [f32],
    nx: usize,
    ny: usize,
...
pub fn decode_partial_block_strided_4d_i32(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i32],
    nx: usize,
    ny: usize,
...
pub fn decode_partial_block_strided_4d_i64(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i64],
    nx: usize,
    ny: usize,
...
pub fn decode_block_strided_4d_f64_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [f64],
    sx: isize,
    sy: isize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_f64(bs, minbits, maxbits, maxprec, minexp);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}

pub fn decode_block_strided_4d_f32_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [f32],
    sx: isize,
    sy: isize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_f32(bs, minbits, maxbits, maxprec, minexp);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}

pub fn decode_block_strided_4d_i32_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i32],
    sx: isize,
    sy: isize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_i32(bs, minbits, maxbits, maxprec);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}

pub fn decode_block_strided_4d_i64_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i64],
    sx: isize,
    sy: isize,
    ...
    let before = bs.read_pos();
    let block = decode_block_4d_i64(bs, minbits, maxbits, maxprec);
    scatter_4d(&block, data, sx, sy, sz, sw);
    (bs.read_pos() - before) as usize
}

pub fn decode_partial_block_strided_4d_f64_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [f64],
    nx: usize,
    ny: usize,
...
pub fn decode_partial_block_strided_4d_f32_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [f32],
    nx: usize,
    ny: usize,
...
pub fn decode_partial_block_strided_4d_i32_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i32],
    nx: usize,
    ny: usize,
...
pub fn decode_partial_block_strided_4d_i64_rate(
    bs: &mut dyn ZfpBitStreamOps,
    data: &mut [i64],
    nx: usize,
    ny: usize,
