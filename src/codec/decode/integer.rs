...
pub fn decode_block_1d_i32(
    ...
    decode_block_1d_i32_core(bs, minbits, maxbits, maxprec)
}
...
pub fn decode_block_1d_i64(
    ...
    decode_block_1d_i64_core(bs, minbits, maxbits, maxprec)
}
...
pub fn decode_block_2d_i32(
    ...
    decode_block_2d_i32_core(bs, minbits, maxbits, maxprec)
}
...
pub fn decode_block_2d_i64(
    ...
    decode_block_2d_i64_core(bs, minbits, maxbits, maxprec)
}
...
pub fn decode_block_3d_i32(
    ...
    decode_block_3d_i32_core(bs, minbits, maxbits, maxprec)
}
...
pub fn decode_block_3d_i64(
    ...
    decode_block_3d_i64_core(bs, minbits, maxbits, maxprec)
}
...
pub fn decode_block_4d_i32(
    ...
    decode_block_4d_i32_core(bs, minbits, maxbits, maxprec)
}
...
pub fn decode_block_4d_i64(
    ...
    decode_block_4d_i64_core(bs, minbits, maxbits, maxprec)
}
